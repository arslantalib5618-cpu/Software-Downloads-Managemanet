...
<head>
  ...
  <title>Filedesk · Add Software</title>
  ...
  <main class="flex-1 flex flex-col overflow-y-auto">
    ...
    <header class="sticky top-0 z-20 bg-white/70 dark:bg-dbg/70 backdrop-blur-md border-b border-line dark:border-dline px-5 sm:px-8 py-3 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-lg font-bold tracking-tight text-ink dark:text-white leading-tight">Add software</h1>
          <p class="text-[11px] text-sub dark:text-dsub font-mono">Software / New</p>
        </div>
      </div>
    ...
    <div class="flex-1 px-5 sm:px-8 py-6 space-y-6 max-w-4xl w-full mx-auto">
      ...
      <section class="hero-banner rounded-2xl shadow-banner px-6 sm:px-10 py-9 sm:py-11">
        ...
        <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div class="max-w-xl">
            ...
            <h2 class="mt-4 text-3xl sm:text-4xl font-extrabold text-white tracking-tight">Add software</h2>
            <p class="mt-2.5 text-sm sm:text-[15px] text-white/75 leading-relaxed">
              Fill in the details below to publish a new app on Filedesk.
            </p>
      ...
      <!-- ===== FORM ===== -->
      <form action="{{ route('softwares.store') }}" method="POST" enctype="multipart/form-data" id="softwareForm" class="space-y-6 pb-4" novalidate>
      @csrf
        <!-- Icon -->
        <div class="section-card p-5 sm:p-7">
          <div class="section-head">
            <div class="section-icon bg-brand-light dark:bg-brand/20 text-brand">
              <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="9" cy="10" r="1.5"/><path d="M21 16L15.5 10.5C15.1 10.1 14.4 10.1 14 10.5L6 18.5"/></svg>
            </div>
            <div>
              <span class="section-num">01</span>
              <h3 class="section-title">App icon</h3>
              <p class="section-sub">Square image, shown across cards and listings.</p>
            </div>
          </div>

          <div class="mt-6 w-32">
            <label for="icon" class="upload-box h-32 @error('icon') has-error @enderror">
              <img id="iconPreview" src="" alt="" class="preview hidden">
              <span id="iconRemove" class="remove-badge" role="button" tabindex="0" aria-label="Remove icon" onclick="removeImage(event, 'icon', 'iconPreview', 'iconPlaceholder', 'iconRemove')">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6L18 18M18 6L6 18"/></svg>
              </span>
              <span id="iconPlaceholder" class="flex flex-col items-center">
                <span class="upload-icon-circle">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5B6472" stroke-width="1.8"><path d="M12 16V4M12 4L7 9M12 4L17 9" /><path d="M4 16V18.5C4 19.6 4.9 20.5 6 20.5H18C19.1 20.5 20 19.6 20 18.5V16"/></svg>
                </span>
                <span class="text-[11.5px] font-semibold text-ink dark:text-dtext">Upload icon</span>
                <span class="text-[10.5px] text-faint dark:text-dsub mt-0.5">PNG, JPG</span>
              </span>
            </label>
            <input type="file" id="icon" name="icon" accept="image/*" class="hidden" aria-describedby="icon_error" onchange="previewImage(this, 'iconPreview', 'iconPlaceholder')" required>
            @error('icon')
              <p id="icon_error" class="field-error">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="9"/><path d="M12 8V13M12 16H12.01"/></svg>
                {{ $message }}
              </p>
            @enderror
          </div>
        ...
        <div class="section-card accent-win p-5 sm:p-7">
          ...
          <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div class="sm:col-span-2">
              ...
              <input type="text" id="title" name="title" class="field-input @error('title') has-error @enderror" placeholder="e.g. Nexus Cleaner" value="{{ old('title') }}" aria-describedby="title_error" required>
              @error('title')
    ...
    @enderror
            ...
            <div class="sm:col-span-2">
              ...
              <textarea id="short_description" name="short_description" rows="2" class="field-input @error('short_description') has-error @enderror" placeholder="One or two lines shown in listing cards" aria-describedby="short_description_error" required>{{ old('short_description') }}</textarea>
        ...
        <div>
    <label for="download_count" class="field-label">
    ...
    @enderror
        ...
        <div class="section-card accent-android p-5 sm:p-7">
          ...
          <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" id="download_button_text" name="download_button_text" class="field-input @error('download_button_text') has-error @enderror" value="{{ old('download_button_text', 'Download Now') }}" aria-describedby="download_button_text_error" required>
            ...
            <div class="input-with-icon">
              ...
              <input type="url" id="download_url" name="download_url" class="field-input @error('download_url') has-error @enderror" placeholder="https://..." value="{{ old('download_url') }}" aria-describedby="download_url_error" required>
              @error('download_url')
            ...
            <div>
              ...
              <input type="text" id="official_button_text" name="official_button_text" class="field-input @error('official_button_text') has-error @enderror" value="{{ old('official_button_text', 'Official Website') }}" aria-describedby="official_button_text_error">
            ...
            <div class="input-with-icon">
              ...
              <input type="url" id="official_website" name="official_website" class="field-input @error('official_website') has-error @enderror" placeholder="https://..." value="{{ old('official_website') }}" aria-describedby="official_website_error">
          ...
          <div class="section-head justify-between w-full">
            <div class="flex items-start gap-4">
              <div class="section-icon bg-amber-light dark:bg-amber/20 text-amber">
                <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="2.5"/><circle cx="8.5" cy="10" r="1.5"/><path d="M21 16L16 11L6 19"/></svg>
              </div>
              <div>
            ...
            <span id="screenshotCounter" class="screenshot-counter shrink-0">0 / 4</span>
          </div>

          <div class="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
              <label for="screenshot_1" class="upload-box h-28 @error('screenshots.0') has-error @enderror">
                <img id="screenshotPreview1" src="" alt="" class="preview hidden">
                <span id="screenshotRemove1" class="remove-badge" role="button" tabindex="0" aria-label="Remove screenshot 1" onclick="removeImage(event, 'screenshot_1', 'screenshotPreview1', 'screenshotPlaceholder1', 'screenshotRemove1')">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6L18 18M18 6L6 18"/></svg>
                </span>
                <span id="screenshotPlaceholder1" class="flex flex-col items-center">
                  <span class="upload-icon-circle w-8 h-8 mb-1.5">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5B6472" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="9" cy="10" r="1.5"/><path d="M21 16L15.5 10.5C15.1 10.1 14.4 10.1 14 10.5L6 18.5"/></svg>
                  </span>
                  <span class="text-[10.5px] font-semibold text-sub dark:text-dsub">Screenshot 1</span>
                </span>
              </label>
              <input type="file" id="screenshot_1" name="screenshots[]" accept="image/*" class="hidden screenshot-input" aria-describedby="screenshot_1_error" onchange="previewImage(this, 'screenshotPreview1', 'screenshotPlaceholder1', 'screenshotRemove1')" required>
              @error('screenshots.0')
                <p id="screenshot_1_error" class="field-error">{{ $message }}</p>
              @enderror
            </div>

            <div>
              <label for="screenshot_2" class="upload-box h-28 @error('screenshots.1') has-error @enderror">
                <img id="screenshotPreview2" src="" alt="" class="preview hidden">
                <span id="screenshotRemove2" class="remove-badge" role="button" tabindex="0" aria-label="Remove screenshot 2" onclick="removeImage(event, 'screenshot_2', 'screenshotPreview2', 'screenshotPlaceholder2', 'screenshotRemove2')">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6L18 18M18 6L6 18"/></svg>
                </span>
                <span id="screenshotPlaceholder2" class="flex flex-col items-center">
                  <span class="upload-icon-circle w-8 h-8 mb-1.5">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5B6472" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="9" cy="10" r="1.5"/><path d="M21 16L15.5 10.5C15.1 10.1 14.4 10.1 14 10.5L6 18.5"/></svg>
                  </span>
                  <span class="text-[10.5px] font-semibold text-sub dark:text-dsub">Screenshot 2</span>
                </span>
              </label>
              <input type="file" id="screenshot_2" name="screenshots[]" accept="image/*" class="hidden screenshot-input" aria-describedby="screenshot_2_error" onchange="previewImage(this, 'screenshotPreview2', 'screenshotPlaceholder2', 'screenshotRemove2')" required>
              @error('screenshots.1')
                <p id="screenshot_2_error" class="field-error">{{ $message }}</p>
              @enderror
            </div>

            <div>
              <label for="screenshot_3" class="upload-box h-28 @error('screenshots.2') has-error @enderror">
                <img id="screenshotPreview3" src="" alt="" class="preview hidden">
                <span id="screenshotRemove3" class="remove-badge" role="button" tabindex="0" aria-label="Remove screenshot 3" onclick="removeImage(event, 'screenshot_3', 'screenshotPreview3', 'screenshotPlaceholder3', 'screenshotRemove3')">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6L18 18M18 6L6 18"/></svg>
                </span>
                <span id="screenshotPlaceholder3" class="flex flex-col items-center">
                  <span class="upload-icon-circle w-8 h-8 mb-1.5">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5B6472" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="9" cy="10" r="1.5"/><path d="M21 16L15.5 10.5C15.1 10.1 14.4 10.1 14 10.5L6 18.5"/></svg>
                  </span>
                  <span class="text-[10.5px] font-semibold text-sub dark:text-dsub">Screenshot 3</span>
                </span>
              </label>
              <input type="file" id="screenshot_3" name="screenshots[]" accept="image/*" class="hidden screenshot-input" aria-describedby="screenshot_3_error" onchange="previewImage(this, 'screenshotPreview3', 'screenshotPlaceholder3', 'screenshotRemove3')" required>
              @error('screenshots.2')
                <p id="screenshot_3_error" class="field-error">{{ $message }}</p>
              @enderror
            </div>

            <div>
              <label for="screenshot_4" class="upload-box h-28 @error('screenshots.3') has-error @enderror">
                <img id="screenshotPreview4" src="" alt="" class="preview hidden">
                <span id="screenshotRemove4" class="remove-badge" role="button" tabindex="0" aria-label="Remove screenshot 4" onclick="removeImage(event, 'screenshot_4', 'screenshotPreview4', 'screenshotPlaceholder4', 'screenshotRemove4')">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6L18 18M18 6L6 18"/></svg>
                </span>
                <span id="screenshotPlaceholder4" class="flex flex-col items-center">
                  <span class="upload-icon-circle w-8 h-8 mb-1.5">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5B6472" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2.5"/><circle cx="9" cy="10" r="1.5"/><path d="M21 16L15.5 10.5C15.1 10.1 14.4 10.1 14 10.5L6 18.5"/></svg>
                  </span>
                  <span class="text-[10.5px] font-semibold text-sub dark:text-dsub">Screenshot 4</span>
                </span>
              </label>
              <input type="file" id="screenshot_4" name="screenshots[]" accept="image/*" class="hidden screenshot-input" aria-describedby="screenshot_4_error" onchange="previewImage(this, 'screenshotPreview4', 'screenshotPlaceholder4', 'screenshotRemove4')" required>
              @error('screenshots.3')
                <p id="screenshot_4_error" class="field-error">{{ $message }}</p>
              @enderror
            </div>
          </div>
        ...
        <div class="section-card accent-mac p-5 sm:p-7">
          ...
          <div class="mt-6 editor-wrap @error('description') has-error @enderror">
            ...
            <textarea id="description" name="description" aria-describedby="description_error" required>{{ old('description') }}</textarea>
          </div>
          @error('description')
